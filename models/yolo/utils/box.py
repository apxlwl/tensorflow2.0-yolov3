...
class BoundBox:
  ...
  def __str__(self):
    return "The x,y,w,h is {},{},{},{}".format(self.x,self.y,self.w,self.h)
...
def nms_boxes(boxes, nms_threshold=0.3, obj_threshold=0.3):
  ...
  n_classes = boxes[0].classes.shape[0]
...
from models.yolo.utils.visualization_utils import visualize_boxes_and_labels_on_image_array
